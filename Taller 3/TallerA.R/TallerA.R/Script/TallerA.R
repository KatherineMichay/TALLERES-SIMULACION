...
source("Material/RANDC.r") # Se abre el archivo RANDC
...
cat("\nProporción de rechazos al 1% =", mean(x < 0.01), "\n") # Para alfa 0.01
cat("Proporción de rechazos al 5% =", mean(x < 0.05), "\n") # Para alfa 0.05
cat("Proporción de rechazos al 10% =", mean(x < 0.1), "\n") # Para alfa 0.1
